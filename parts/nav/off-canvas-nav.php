...
<div class="off-canvas-wrapper">
    ...
    <nav class="off-canvas position-right text-white text-center padding-top-2" id="off-canvas" data-off-canvas>
        <div class="cell large-4 medium-6  small-6 padding-bottom-2">
            <a href="/" >
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/util/kwbel-logo.svg" width="150" alt="KWBEL LOGO"/>
            </a>
        </div>
        ...
        wp_nav_menu(
            array(
                ...
                'container' => '',
                'items_wrap' => '<ul class="vertical custom-nav-menu menu">%3$s</ul>',
